...
-- fill the gap: createProductReview refuses anyone without a `delivered` order
-- containing the product, so the only people who could post about a product
-- were those for whom the purchase decision was already made.
