/**
 * E-Commerce Website - Summer Collection Logic
...
(function() {
    ...
    const fallbackProducts = [
        { 
            ...
            name: 'Beach Wear', 
            price: 550.00, 
            image: 'assets/images/BeachShirt.jpg', 
            category: 'women', 
            brand: 'H&M',
            stock: 12, 
            rating: 5 
        ...
        { 
            ...
            name: 'Mens Comfort', 
            price: 350.00, 
            image: 'assets/images/menscasual.jpg', 
            category: 'men', 
            brand: 'Levis',
            stock: 25, 
            rating: 4 
        ...
        { 
            ...
            name: 'Women Tops', 
            price: 250.00, 
            image: 'assets/images/SummerTop.webp', 
            category: 'women', 
            brand: 'Zara',
            stock: 8, 
            rating: 5 
        ...
        { 
            ...
            name: 'Combo Set', 
            price: 899.00, 
            image: 'assets/images/ComboSet.jpg', 
            category: 'combo', 
            brand: 'Zara',
            stock: 8, 
            rating: 5 
    ...
    function renderProducts(products) {
        ...
        if (products.length === 0) {
            elements.productContainer.innerHTML = `<p class="no-products">No products found in Summer Collection.</p>`;
            return;
        }
